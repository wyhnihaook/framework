...
/**
 * Created by 翁益亨 on 2019/3/28.
 */
public class SystemBarUtil {

    public static Boolean isWelcome=true;//默认开启app会走引导页，其他页面置为false
    /**
     * 在引导页的时候要全屏
     * 当布局的根View设置属性fitsSystemWindows为true时，当用户设置全屏状态时，会默认生成顶部状态栏高度的paddingTop
     * */
    public static void setSystemBar(Activity activity,int color,boolean isBlack) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            Window window = activity.getWindow();
            window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
            window.getDecorView().setSystemUiVisibility(isWelcome? (View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN | View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR):View.SYSTEM_UI_FLAG_LAYOUT_STABLE);//取消全屏模式
