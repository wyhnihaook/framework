...
public class CircularProgressDrawable extends Drawable
    ...
    public static class Builder {
        ...
        private void initValues(Context context, boolean editMode) {
            mStrokeWidth = context.getResources().getDimension(R.dimen.module_public_cpb_default_stroke_width);
            mSweepSpeed = 1f;
            mRotationSpeed = 1f;
            if (editMode) {
                ...
                mColors = new int[]{context.getResources().getColor(R.color.module_public_cpb_default_color)};
                mMinSweepAngle = context.getResources().getInteger(R.integer.module_public_cpb_default_min_sweep_angle);
                mMaxSweepAngle = context.getResources().getInteger(R.integer.module_public_cpb_default_max_sweep_angle);
            }
